...
The $n=1$ wavefunction is the lowest energy state with one node. Both isotopes will have the same wave shape, but because $^{12}$C is lighter, it has a higher ground-state energy.
