...
The $n=1$ wavefunction is the lowest energy state with no internal nodes. Both isotopes have the same wave shape, but because $^{12}$C has less mass, it has a higher energy.
