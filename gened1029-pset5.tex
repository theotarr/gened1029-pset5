...
Both have the same $n=1$ wave shape (one hump). Because $^{12}$C is lighter, it has a higher ground-state energy.
...
\textbf{(d)} At higher temperature, thermal energy $k_BT$ grows, so the energy difference $\Delta E$ becomes relatively smaller. The rate ratio approaches 1 and fractionation weakens — both isotopes react at nearly the same rate.
