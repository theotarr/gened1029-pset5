...
\begin{figure}
    ...
    \caption{Ground-state ($n=1$) wavefunctions for $^{12}$C (blue) and $^{13}$C (red) in a box of width $L=0.2$ nm. Both have the same half-sine shape, but $^{12}$C sits at a higher energy level because it is lighter ($E_1 \propto 1/m$).}
