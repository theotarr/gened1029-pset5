...
For $n=1$, with $h^2 = (6.626\times10^{-34})^2 = 4.390\times10^{-67}\ \text{J}^2\text{s}^2$ and $L^2 = (2\times10^{-10})^2 = 4\times10^{-20}\ \text{m}^2$:

\[
8\,m_{^{12}\text{C}}\,L^2 = 8 \times 2.004\times10^{-26} \times 4\times10^{-20} = 6.413\times10^{-45}
\]
\[
E_1(^{12}\text{C}) = \frac{4.390\times10^{-67}}{6.413\times10^{-45}} = 6.85\times10^{-23}\ \text{J} \approx 0.427\ \text{meV}
\]
\[
8\,m_{^{13}\text{C}}\,L^2 = 8 \times 2.171\times10^{-26} \times 4\times10^{-20} = 6.947\times10^{-45}
\]
\[
E_1(^{13}\text{C}) = \frac{4.390\times10^{-67}}{6.947\times10^{-45}} = 6.32\times10^{-23}\ \text{J} \approx 0.394\ \text{meV}
\]

The $n=1$ wavefunction is the lowest energy state with no internal nodes. Both isotopes have the same wave shape, but because $^{12}$C is lighter, it has a higher ground-state energy.

\smallskip
\noindent\textit{Note: The $n=1$ energy is called the zero-point energy (or ground state energy). It is the minimum energy a quantum particle can have. Unlike a classical particle, which could sit still at zero energy, quantum mechanics requires the particle to always be moving due to the uncertainty principle, so there is always some minimum energy even in the lowest state.}
